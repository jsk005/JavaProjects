...
public class CipherUtils extends AppCompatActivity {
    ...
    private static final String AESkey = "TBbitk1076januey991ggis19597kims"; // AES 암호화  키
    private static final String URLKey = "jgr89721sysyks3579"; // URL 신뢰성 향상을 위해 사용하는 키
