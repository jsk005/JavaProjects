...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            ...
            DBContract.Entry._IDX + " TEXT not null unique," +
            DBContract.Entry._NAME +" TEXT not null," +
            DBContract.Entry._MobileNO + " TEXT not null," +
            DBContract.Entry._telNO + " TEXT," +
            DBContract.Entry._Team + " TEXT," +
            DBContract.Entry._Mission + " TEXT," +
            DBContract.Entry._Position + " TEXT," +
            DBContract.Entry._Photo + " TEXT," +
            DBContract.Entry._Status + " TEXT);";
