...
public class MapViewFragment extends Fragment implements OnMapReadyCallback {
    ...
    private static final int UPDATE_INTERVAL_MS = 1000 * 60 * 10;  // 10분 단위 시간 갱신
    ...
    public MapViewFragment() {
        // 지도가 보이게 하려면 https://link2me.tistory.com/1914 를 참조하여
        // 패키지 이름과 PC/노트북의 SHA-1 인증서 디지털 지문을 등록해야 한다.
    }
