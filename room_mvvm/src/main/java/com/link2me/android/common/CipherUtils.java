...
import com.link2me.android.room_mvvm.GValue;
...
public class CipherUtils extends AppCompatActivity {
    ...
    private static final String AESkey = "TBbit1076janukikey991ggis19597ms"; // AES 암호화  키
    private static final String URLKey = "jgsyksr8972sy13579"; // URL 신뢰성 향상을 위해 사용하는 키
