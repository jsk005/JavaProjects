package com.link2me.android.room_mvvm.view.adapter;


import static com.link2me.android.room_mvvm.view.activity.MainActivity.constraintLayout;
import static com.link2me.android.room_mvvm.view.activity.MainActivity.isCheckFlag;
...
import com.link2me.android.room_mvvm.R;
import com.link2me.android.room_mvvm.databinding.ItemAddressBinding;
...
public class AddressListAdapter extends ListAdapter<Address_Item, AddressListAdapter.ViewHolder> {
    ...
    private static final DiffUtil.ItemCallback<Address_Item> DIFF_CALLBACK = new DiffUtil.ItemCallback<Address_Item>() {
        @Override
        public boolean areItemsTheSame(Address_Item oldItem, Address_Item newItem) {
            return oldItem.getIdx() == newItem.getIdx();
        }

        @Override
        public boolean areContentsTheSame(Address_Item oldItem, Address_Item newItem) {
            return oldItem.getUserNM().equals(newItem.getUserNM()) &&
                    oldItem.getMobileNO().equals(newItem.getMobileNO()) &&
                    oldItem.getTelNO().equals(newItem.getTelNO()) &&
